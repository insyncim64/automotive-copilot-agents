---
name: v2x-cv2x
description: "Use when: Skill: C-V2X (Cellular Vehicle-to-Everything) Communication topics are needed for automotive embedded and systems engineering tasks."
---
# Skill: C-V2X (Cellular Vehicle-to-Everything) Communication

## Skill Intent
- Reusable Copilot skill converted from context source: .github/copilot/context/skills/v2x/cv2x.md
