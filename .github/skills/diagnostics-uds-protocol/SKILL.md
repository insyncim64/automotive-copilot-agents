---
name: diagnostics-uds-protocol
description: "Use when: Skill: UDS Protocol Implementation topics are needed for automotive embedded and systems engineering tasks."
---
# Skill: UDS Protocol Implementation

## Skill Intent
- Reusable Copilot skill converted from context source: .github/copilot/context/skills/diagnostics/uds-protocol.md
