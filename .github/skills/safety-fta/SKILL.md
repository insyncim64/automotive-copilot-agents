---
name: safety-fta
description: "Use when: Skill: FTA (Fault Tree Analysis) topics are needed for automotive embedded and systems engineering tasks."
---
# Skill: FTA (Fault Tree Analysis)

## Skill Intent
- Reusable Copilot skill converted from context source: .github/copilot/context/skills/safety/fta.md
