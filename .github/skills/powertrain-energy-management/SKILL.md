---
name: powertrain-energy-management
description: "Use when: Skill: Energy Management for Automotive Powertrain topics are needed for automotive embedded and systems engineering tasks."
---
# Skill: Energy Management for Automotive Powertrain

## Skill Intent
- Reusable Copilot skill converted from context source: .github/copilot/context/skills/powertrain/energy-management.md
