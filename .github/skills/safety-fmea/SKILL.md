---
name: safety-fmea
description: "Use when: Skill: FMEA (Failure Mode and Effects Analysis) topics are needed for automotive embedded and systems engineering tasks."
---
# Skill: FMEA (Failure Mode and Effects Analysis)

## Skill Intent
- Reusable Copilot skill converted from context source: .github/copilot/context/skills/safety/fmea.md
