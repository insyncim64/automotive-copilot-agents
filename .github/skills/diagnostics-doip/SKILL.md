---
name: diagnostics-doip
description: "Use when: Skill: Diagnostic over IP (DoIP) - ISO 13400 topics are needed for automotive embedded and systems engineering tasks."
---
# Skill: Diagnostic over IP (DoIP) - ISO 13400

## Skill Intent
- Reusable Copilot skill converted from context source: .github/copilot/context/skills/diagnostics/doip.md
