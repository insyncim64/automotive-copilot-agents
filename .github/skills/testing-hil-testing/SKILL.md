---
name: testing-hil-testing
description: "Use when: Skill: Hardware-in-the-Loop (HIL) Testing for Automotive ECUs topics are needed for automotive embedded and systems engineering tasks."
---
# Skill: Hardware-in-the-Loop (HIL) Testing for Automotive ECUs

## Skill Intent
- Reusable Copilot skill converted from context source: .github/copilot/context/skills/testing/hil-testing.md
