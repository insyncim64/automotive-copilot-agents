---
name: chassis-brake-by-wire
description: "Use when: Skill: Brake-by-Wire Control Systems topics are needed for automotive embedded and systems engineering tasks."
---
# Skill: Brake-by-Wire Control Systems

## Skill Intent
- Reusable Copilot skill converted from context source: .github/copilot/context/skills/chassis/brake-by-wire.md
