---
name: testing-mil-testing
description: "Use when: Skill: Model-in-the-Loop (MIL) Testing for Automotive Control Systems topics are needed for automotive embedded and systems engineering tasks."
---
# Skill: Model-in-the-Loop (MIL) Testing for Automotive Control Systems

## Skill Intent
- Reusable Copilot skill converted from context source: .github/copilot/context/skills/testing/mil-testing.md
