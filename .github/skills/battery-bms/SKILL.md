---
name: battery-bms
description: "Use when: Skill: Battery Management System (BMS) topics are needed for automotive embedded and systems engineering tasks."
---
# Skill: Battery Management System (BMS)

## Skill Intent
- Reusable Copilot skill converted from context source: .github/copilot/context/skills/battery/bms.md
