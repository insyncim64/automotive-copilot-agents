---
name: adas-collision-avoidance
description: "Use when: Skill: Collision Avoidance System Development topics are needed for automotive embedded and systems engineering tasks."
---
# Skill: Collision Avoidance System Development

## Skill Intent
- Reusable Copilot skill converted from context source: .github/copilot/context/skills/adas/collision-avoidance.md
