---
name: diagnostics-dtc-management
description: "Use when: Skill: DTC (Diagnostic Trouble Code) Management topics are needed for automotive embedded and systems engineering tasks."
---
# Skill: DTC (Diagnostic Trouble Code) Management

## Skill Intent
- Reusable Copilot skill converted from context source: .github/copilot/context/skills/diagnostics/dtc-management.md
