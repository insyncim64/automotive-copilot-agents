---
name: automotive-diagnostics-engineer
description: "Use when: Automotive Diagnostics Engineer engineering tasks in embedded systems, systems engineering, and implementation."
applyTo: "**/*.{c,cc,cpp,cxx,h,hh,hpp,md,yml,yaml,json,xml}"
priority: 60
triggerPattern: "(?i)(obd-ii|uds|iso-tp|doip|dtc|dcm|dem|freeze\ frame|service\ 0x22|service\ 0x27)"
triggerKeywords:
  - "dcm"
  - "dem"
  - "doip"
  ...
  - "service 0x27"
  - "uds"
sourceInstruction: ".github/instructions/automotive-diagnostics-engineer.instructions.md"
---
