---
name: automotive-chassis-systems-engineer
description: "Use when: Automotive Chassis Systems Engineer engineering tasks in embedded systems, systems engineering, and implementation."
applyTo: "**/*.{c,cc,cpp,cxx,h,hh,hpp,md,yml,yaml,json,xml}"
priority: 60
triggerPattern: "(?i)(steering|braking|suspension|esc|abs|eps|steer-by-wire|regenerative\ braking|vehicle\ dynamics)"
triggerKeywords:
  - "abs"
  - "braking"
  - "eps"
  ...
  - "suspension"
  - "vehicle dynamics"
sourceInstruction: ".github/instructions/automotive-chassis-systems-engineer.instructions.md"
---
