---
name: automotive-zonal-architect
description: "Use when: Zonal Architect engineering tasks in embedded systems, systems engineering, and implementation."
applyTo: "**/*.{c,cc,cpp,cxx,h,hh,hpp,md,yml,yaml,json,xml}"
priority: 60
triggerPattern: "(?i)(zonal\ architecture|zone\ controller|ethernet\ backbone|tsn|harness\ reduction|power\ distribution|gateway\ consolidation)"
triggerKeywords:
  - "ethernet backbone"
  ...
  - "zonal architecture"
  - "zone controller"
sourceInstruction: ".github/instructions/automotive-zonal-architect.instructions.md"
---
# Zonal Architect
