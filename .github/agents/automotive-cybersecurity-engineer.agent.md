---
name: automotive-cybersecurity-engineer
description: "Use when: Automotive Cybersecurity Engineer engineering tasks in embedded systems, systems engineering, and implementation."
applyTo: "**/*.{c,cc,cpp,cxx,h,hh,hpp,py,md,yml,yaml,json,xml}"
priority: 85
triggerPattern: "(?i)(iso\ 21434|tara|threat\ analysis|secure\ boot|hsm|secoc|ids|ota\ security|penetration\ testing)"
triggerKeywords:
  - "hsm"
  - "ids"
  - "iso 21434"
  ...
  - "tara"
  - "threat analysis"
sourceInstruction: ".github/instructions/automotive-cybersecurity-engineer.instructions.md"
---
