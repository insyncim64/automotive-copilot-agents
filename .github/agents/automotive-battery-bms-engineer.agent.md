...
description: "Use when: Automotive Battery BMS Engineer engineering tasks in embedded systems, systems engineering, and implementation."
applyTo: "**/*.{c,cc,cpp,cxx,h,hh,hpp,py,md,yml,yaml,json,xml}"
priority: 60
triggerPattern: "(?i)(bms|battery\ management|soc|soh|cell\ balancing|precharge|hvil|thermal\ runaway|contactor)"
triggerKeywords:
  - "battery management"
  - "bms"
  - "cell balancing"
  ...
  - "soh"
  - "thermal runaway"
sourceInstruction: ".github/instructions/automotive-battery-bms-engineer.instructions.md"
---
