---
name: automotive-v2x-system-engineer
description: "Use when: V2X System Engineer engineering tasks in embedded systems, systems engineering, and implementation."
applyTo: "**/*.{c,cc,cpp,cxx,h,hh,hpp,py,md,yml,yaml,json,xml}"
priority: 60
triggerPattern: "(?i)(v2x|dsrc|c-v2x|j2735|bsm|spat|map\ message|rsu|scms)"
triggerKeywords:
  - "bsm"
  - "c-v2x"
  - "dsrc"
  ...
  - "spat"
  - "v2x"
sourceInstruction: ".github/instructions/automotive-v2x-system-engineer.instructions.md"
---
# V2X System Engineer
