...
priority: 60
triggerPattern: "(?i)(ev|battery\ pack|soc|soh|cell\ monitoring|thermal\ management|contactor\ control|charging|high\ voltage)"
triggerKeywords:
  - "battery pack"
  - "cell monitoring"
  - "charging"
  ...
  - "soh"
  - "thermal management"
sourceInstruction: ".github/instructions/automotive-ev-systems-specialist.instructions.md"
---
