---
name: automotive-functional-safety-engineer
description: "Use when: Automotive Functional Safety Engineer engineering tasks in embedded systems, systems engineering, and implementation."
applyTo: "**/*.{md,c,cc,cpp,cxx,h,hh,hpp,yml,yaml,xml}"
priority: 90
triggerPattern: "(?i)(iso\ 26262|hara|asil|fmea|fta|safety\ goal|diagnostic\ coverage|freedom\ from\ interference)"
triggerKeywords:
  - "asil"
  - "diagnostic coverage"
  - "fmea"
  ...
  - "iso 26262"
  - "safety goal"
sourceInstruction: ".github/instructions/automotive-functional-safety-engineer.instructions.md"
---
