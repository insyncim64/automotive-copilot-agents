...
priority: 80
triggerPattern: "(?i)(pid|lqr|mpc|acc|stop-and-go|longitudinal\ control|lateral\ control|esc|abs|trajectory\ tracking|asil-d)"
triggerKeywords:
  - "abs"
  - "acc"
  - "asil-d"
  ...
  - "stop-and-go"
  - "trajectory tracking"
sourceInstruction: ".github/instructions/automotive-adas-control-engineer.instructions.md"
---
