...
priority: 80
triggerPattern: "(?i)(sensor\ fusion|camera|radar|lidar|object\ detection|yolo|tracking|perception\ pipeline|sotif|false\ positive)"
triggerKeywords:
  - "camera"
  - "false positive"
  - "lidar"
  ...
  - "tracking"
  - "yolo"
sourceInstruction: ".github/instructions/automotive-adas-perception-engineer.instructions.md"
---
